...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 h-screen flex flex-col relative border-r border-gray-200 dark:border-gray-700">
      ...
      <div className="relative flex-shrink-0 p-4 bg-gradient-to-r from-gray-100 to-gray-50 dark:from-gray-100 dark:to-gray-200 border-b border-gray-200 dark:border-gray-300 z-20">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-sm font-bold text-gray-800 dark:text-gray-800 leading-tight">Philippine Ports Authority</h1>
            <p className="text-xs text-gray-500 dark:text-gray-600">Attendance Monitoring</p>
          </div>
          {/* Theme Toggle Button */}
          <button
            onClick={toggleTheme}
            className="p-2 rounded-lg bg-gray-200/50 dark:bg-gray-300/50 hover:bg-gray-300/50 dark:hover:bg-gray-400/50 transition-colors"
            title={theme === "dark" ? "Switch to Light Mode" : "Switch to Dark Mode"}
          >
            {theme === "dark" ? (
              <svg className="w-5 h-5 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
      ...
      <div className="flex-shrink-0 p-4 border-t border-gray-200/50 dark:border-gray-700/50 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm relative z-20">
